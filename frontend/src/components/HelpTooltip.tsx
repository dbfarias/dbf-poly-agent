...
export default function HelpTooltip({ text, size = 13 }: HelpTooltipProps) {
  ...
  return (
    <div ref={ref} className="relative inline-flex items-center">
      ...
      {open && (
        <div
          className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 px-3 py-2 rounded-lg bg-[#2a2d3e] border border-[#3a3d4e] text-xs text-zinc-300 leading-relaxed shadow-lg"
